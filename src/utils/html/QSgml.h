...
public:
   ...
   void getElementsByAttribute(QString AtrName,QList<QSgmlTag*> *Elements);
   void getElementsByAttribute(QString AtrName,QString AtrValue,QList<QSgmlTag*> *Elements);
